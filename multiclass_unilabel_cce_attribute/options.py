...
class BaseOptions():
    ...
    def initialize(self):
        self.parser.add_argument('--run_dir', default='/dccstor/cssblr/amrita/Concept_Catalog_GQA/multiclass_unilabel_cce_attribute', type=str, help='experiment directory')
        self.parser.add_argument('--image_dir', default='/dccstor/cssblr/amrita/GQA/data/images/', type=str, help='directory containing VisualGenome images')
        self.parser.add_argument('--dataset', default='gqa', type=str, help='dataset')
        ...
        self.parser.add_argument('--vocab_file', default='attribute_concepts.json', type=str, help='file containing clusters of attributes')
        self.parser.add_argument('--cluster_file', default='attribute_concept_clusters.json', type=str, help='file containing clusters of attributes')
        ...
        self.parser.add_argument('--learning_rate', default=5e-4, type=float, help='learning rate')
    ...
    def parse(self):
        ...
        print ('gpu ids ', self.opt.gpu_ids, torch.cuda.is_available())
...
class TrainOptions(BaseOptions):
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--preprocessed_data_dir', default='/dccstor/cssblr/amrita/GQA/data/preprocessed', type=str, help='directory consisting of the preprocessed data for training')
        self.parser.add_argument('--preprocessed_pos_data', default='train_attribute_regions.pkl', type=str, help='file name consisting of the preprocessed positive data for training')
        self.parser.add_argument('--image_concepts_glove_emb_file', default='train_image_concepts_glove_embedding.pkl', type=str, help='file containing glove embedding of image concepts')
        self.parser.add_argument('--max_iters', default=100000, type=int, help='maximum number of iterations/batches')
        self.parser.add_argument('--max_epochs', default=3, type=int, help='maximum number of epochs')
...
class TestOptions(BaseOptions):
    def initialize(self):
        BaseOptions.initialize(self)
        self.parser.add_argument('--preprocessed_data_dir', default='/dccstor/cssblr/amrita/GQA/data/preprocessed', type=str, help='directory name where preprocessed validation')
        self.parser.add_argument('--preprocessed_pos_data', default='val_attribute_regions.pkl', type=str, help='file name consisting of the preprocessed positive data for validation')
        self.parser.add_argument('--image_concepts_glove_emb_file', default='val_image_concepts_glove_embedding.pkl', type=str, help='file containing glove embedding of image concepts')
